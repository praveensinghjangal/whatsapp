...
const app_name = "otp_api"; //remember to rename this variable with new name(without spaces), it will also act as default mongodb database name and logging file name
const db_name = "otp_api"; //change if you want to have different database name than the application name.
let all = {
