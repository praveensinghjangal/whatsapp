 ...
 */
  ...
  getBusinessProfileListByStatusId (columnArray, offset, ItemsPerPage, startDate, endDate, searchText, valArray) {
    __logger.info('get Business Profile List By Status Id::>>>>>>>>>>>>>.', valArray)
    const status = q.defer()
    __db.mysql.query(__constants.HW_MYSQL_NAME, queryProvider.getBusinessProfileListByStatusId(columnArray, startDate, endDate, searchText), [...valArray, ItemsPerPage, offset])
      .then(result => {
