    ...
    .then(result => {
      ...
      return __util.send(res, {
        ...
        data: {
          ...
          inActiveRecords: result && result[0] && result[0] && result[1] && result[1].totalUsers && result[0].totalActiveUsers !== null && result[0].totalActiveUsers !== undefined ? result[1].totalUsers - result[0].totalActiveUsers : 0 // done seperate check for null n unedfine as active users can be 0
        }
      })
    })
    .catch(err => {
