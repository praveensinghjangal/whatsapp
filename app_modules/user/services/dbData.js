...
class UserData {
  ...
  getAllAgreement (columnArray, offset, ItemsPerPage, startDate, endDate, searchBy, searchText, valArray) {
    __logger.info('Inside getAllAgreement')
    const fetchAgreement = q.defer()
    __db.mysql.query(__constants.HW_MYSQL_NAME, queryProvider.getAgreementList(columnArray, startDate, endDate, searchBy, searchText), [...valArray, ItemsPerPage, offset])
      .then(result => {
