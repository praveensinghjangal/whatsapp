...
router.post("/", user_func.create_senderid);
router.get("/", user_func.view_senderid);
router.get("/:sender_uuid", user_func.view_single_senderid);
router.put("/approve/:sender_uuid", user_func.approve_senderid);
router.put("/change_status/:sender_uuid", user_func.change_status_senderid);
