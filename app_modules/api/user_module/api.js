...
user_module_func.get_user_info = (req, res) => {
    __util.make_log_statement(req, "get_user_info");
    // console.log(req.query)
    const user_id = req.query.user_id;
    let sql_param = [user_id];
    let sql_query = "select u.username,first_name,last_name,email_id,mobile_number,company_name,industry,otp_purpose,created_at,modified_at,package_selected from users u where u.user_id like ?";
...
user_module_func.update_user_info = (req, res) => {
...
user_module_func.user_settings = (req, res) => {
...
module.exports = user_module_func;
