...
class redisLib {
    constructor() {
       __logger.info("redisLib.constructor called.");
    ...
    init() {
        return new Promise((resolve, reject) => {
           ...
           __logger.info('redisLib.init, initializing redis connection ', { port: __config.redis.port, host: __config.redis.host, uri: __config.redis.uri });
