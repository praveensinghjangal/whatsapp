...
class redisLib extends redis_lib{
    ...
    init() {
        return new Promise((resolve, reject) => {
            ...
            __logger.debug('redisLib.init, initializing redis connection ', { port: __config.redis_remote_2.port, host: __config.redis_remote_2.host, uri: __config.redis_remote_2.uri });
