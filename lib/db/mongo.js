/**
 *
 * @author deepak.ambekar [11/02/2017].
 */
...
class mongoLib {
    ...
    init() {
        return new Promise((resolve, reject) => {
            ...
            MongoClient.connect(__config.mongo.uri, {useNewUrlParser: true}, (err, connection) => {
                if (err) {
    ...
    __getDbNameWithArchive(db_referrer) {
        ...
        try {
            if (!_.isEmpty(__define.MONGO_DBS)) {
                for (var key in __define.MONGO_DBS) {
                    var db_config = __define.MONGO_DBS[key];
...
//        console.log("******************db_name::", db_name);
        ...
        return new Promise((resolve, reject) => {
            ...
            if (vm.connection) {
                if (db_name) {
                    ...
                    // __logger.debug('lib_mongo.__getMongoDbConnection::', {uri: __config.mongo.uri, db_name: db_name});
                    if (conn) {
                        resolve(conn);
                    } else {
    ...
    __findOne(db_name, collection_name, find_params, select_params) {
        __logger.debug('lib_mongo.__findOne, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __find(db_name, collection_name, find_params, select_params) {
        __logger.debug('lib_mongo.__find, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
                select_params = select_params || {};
    ...
    __insert(db_name, collection_name, document) {
        __logger.debug('lib_mongo.__insert, request', {db: db_name, collection: collection_name, document: document});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __update(db_name, collection_name, find_params, update_params) {
        __logger.debug('lib_mongo.__update, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __update_addToSet(db_name, collection_name, find_params, update_params) {
        __logger.debug('lib_mongo.__update_addToSet, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __incr(db_name, collection_name, find_params, update_params, update_options) {
        __logger.debug('lib_mongo.__incr, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __push(db_name, collection_name, find_params, push_params, update_params) {
        __logger.debug('lib_mongo.__push, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
                var update_fields = {};
    ...
    __delete(db_name, collection_name, find_params) {
        __logger.debug('lib_mongo.__delete, request', {db: db_name, collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __eval(db_name, mongo_function, find_param) {
        __logger.debug('lib_mongo.__eval, request', {db: db_name, function: mongo_function, params: find_param});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
    ...
    __count(db_name, collection_name, find_params) {
        __logger.debug('lib_mongo.__count, request', {db: 'mongo', collection: collection_name, params: find_params});
        return new Promise((resolve, reject) => {
            var vm = this;
            vm.__getMongoDbConnection(db_name).then((connection) => {
