...
const VivaLogger = require('viva-logger')
module.exports = new VivaLogger(config.logging.log_file, true)
...
// const vivaLogger = new VivaLogger(config.logging.log_file, true)
