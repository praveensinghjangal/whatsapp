...
module.exports = function (app) {
    ...
    //region api routes
    // const api_url_prefix = '/' + __config.api_prefix + __config.authConfig.apiAuthAlias + '/api';
    ...
    // });
    require('../lib/swagger')(app, '/' + __config.api_prefix + __config.authConfig.apiAuthAlias);
};
