...
const messageStatusOnMailForConversation = () => {
  ...
  dbService.getMisRelatedData()
    ...
    .then(dbresponse => {
      ...
      console.log('111111111111111111111111111111111111111', passingObjectToMailer.lastDayAllUserCount)
      console.log('222222222222222222222222222222222222222', passingObjectToMailer.lastDayTotalStatusCount)
      console.log('333333333333333333333333333333333333333', passingObjectToMailer.lastDayTotalMessageCount)
      console.log('444444444444444444444444444444444444444', passingObjectToMailer.mtdAllUserCount)
      console.log('555555555555555555555555555555555555555', passingObjectToMailer.mtdTotalStatusCount)
      console.log('666666666666666666666666666666666666666', passingObjectToMailer.mtdTotalMessageCount)
      console.log('777777777777777777777777777777777777777', passingObjectToMailer.lastDayTotalMessageCount)
      console.log('888888888888888888888888888888888888888', userIdToUserName)
